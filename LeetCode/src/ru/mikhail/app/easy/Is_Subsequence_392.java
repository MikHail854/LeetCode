...
public class Is_Subsequence_392 {
    public boolean isSubsequence(String s, String t) {
        int indx = 0;
        for (int i = 0; i < t.length() && indx < s.length(); i++){
            if (t.charAt(i) == s.charAt(indx))
                indx++;
        }
    ...
    public static void main(String[] args) {
        Is_Subsequence_392 function = new Is_Subsequence_392();
        String s = "abc";
        String t = "ahbgdc";
        System.out.println(function.isSubsequence(s, t));
    }
}
